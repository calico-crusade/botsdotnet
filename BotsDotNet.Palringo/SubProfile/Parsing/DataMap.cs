...
namespace BotsDotNet.Palringo.SubProfile.Parsing
{
    /// <summary>
    ...
    public class DataMap : IEnumerable
    {
        ...
        public DataMap(string data)
            : this(Networking.PacketSerializer.Outbound.GetBytes(data)) { }
        ...
        /// 
        /// </summary>
        public Dictionary<string, string> StrData => Data.ToDictionary(t => t.Key, t => Networking.PacketSerializer.Outbound.GetString(t.Value));
        ...
        public string GetValue(string string_0)
        {
            ...
            return Networking.PacketSerializer.Outbound.GetString(item, 0, item.Length);
        }
        ...
        public float GetValueFloat(string string_0)
        {
            ...
            {
                byte[] item = hiddenData[string_0];
                string str = Networking.PacketSerializer.Outbound.GetString(item, 0, item.Length);
                if (float.TryParse(str, out float single))
                {
                    return single;
                }
            }
        ...
        public byte[] Serialize()
        {
            ...
            foreach (KeyValuePair<string, byte[]> dictionary0 in hiddenData)
            {
                ...
                do
                {
                    ...
                    int num = (length1 > 65535 ? 65535 : length1);
                    int num3 = num;
                    byte[] bytes = Networking.PacketSerializer.Outbound.GetBytes(dictionary0.Key);
        ...
        {
            SetNestedAttribute(path, string_0, Networking.PacketSerializer.Outbound.GetBytes(string_1));
        }
        ...
        public void SetValue(string string_0, string string_1)
        {
            ...
            if (string_1 != null)
            {
                hiddenData[string_0] = Networking.PacketSerializer.Outbound.GetBytes(string_1);
            }
            else
            {
                hiddenData[string_0] = Networking.PacketSerializer.Outbound.GetBytes(string.Empty);
            }
        }
        ...
        {
            string_0 = string_0.ToLower();
            hiddenData[string_0] = Networking.PacketSerializer.Outbound.GetBytes(int_0.ToString(CultureInfo.InvariantCulture));
        }
        ...
        {
            string_0 = string_0.ToLower();
            hiddenData[string_0] = Networking.PacketSerializer.Outbound.GetBytes(uint_0.ToString(CultureInfo.InvariantCulture));
        }
        ...
        {
            string_0 = string_0.ToLower();
            hiddenData[string_0] = Networking.PacketSerializer.Outbound.GetBytes(long_0.ToString(CultureInfo.InvariantCulture));
        }
        ...
        {
            string_0 = string_0.ToLower();
            hiddenData[string_0] = Networking.PacketSerializer.Outbound.GetBytes(ulong_1.ToString(CultureInfo.InvariantCulture));
        }
