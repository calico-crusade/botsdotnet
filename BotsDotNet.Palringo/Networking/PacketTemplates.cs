...
namespace BotsDotNet.Palringo.Networking
{
    using SubProfile;
    ...
    public interface IPacketTemplates
    {
        ...
        IPacket AdminAction(AdminActions action, string user, string group);
        IPacket AddContact(string user, string message = "I'd like to add you!");
        IPacket AddContactResponse(bool accept, string user);
        ...
        IPacket LeaveGroup(string groupId);
        IPacket Bye();
    ...
    public class PacketTemplates : IPacketTemplates
    {
        ...
        public IPacket Message(MessageType target, DataType type, string id, string data)
        {
        ...
        public IPacket AddContact(string user, string message = "I'd like to add you!")
        {
            return new Packet
            {
                Command = "CONTACT ADD",
        ...
        public IPacket AddContactResponse(bool accept, string user)
        {
            return new Packet
            {
        ...
        public IPacket LeaveGroup(string groupId)
        {
            return new Packet
            {
                Command = "GROUP UNSUB",
