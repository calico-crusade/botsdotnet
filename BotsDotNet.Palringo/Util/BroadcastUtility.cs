...
namespace BotsDotNet.Palringo.Util
{
    ...
    public interface IBroadcastUtility
    {
        ...
        event MappedPacketCarrier<MessagePacket> Message;
    ...
    public class BroadcastUtility : IBroadcastUtility
    {
        ...
        public void BroadcastThrottle(PalBot bot, Throttle throttle) => Throttle(bot, throttle);
        #endregion

        #region Admin Action
        public event MappedPacketCarrier<AdminAction> AdminAction = delegate { };
        public void BroadcastAdminAction(PalBot bot, AdminAction action) => AdminAction(bot, action);
        #endregion

        #region Group Update
        public event MappedPacketCarrier<GroupUpdate> GroupUpdate = delegate { };
        public void BroadcastGroupUpdate(PalBot bot, GroupUpdate update) => GroupUpdate(bot, update);
        #endregion

        #region Login Failed
        public event MappedPacketCarrier<LoginFailed> LoginFailed = delegate { };
        public void BroadcastLoginFailed(PalBot bot, LoginFailed failed) => LoginFailed(bot, failed);
        #endregion

        #region Message
        public event MappedPacketCarrier<MessagePacket> Message = delegate { };
        public void BroadcastMessage(PalBot bot, MessagePacket message) => Message(bot, message);
        #endregion
