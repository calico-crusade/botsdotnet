...
namespace BotsDotNet.WebExTeams.SparkDotNet
{
    ...
    public partial class Spark
    {
        ...
        public async Task<List<SparkMessage>> GetMessagesAsync(string roomId, string mentionedPeople = null, string before = null, string beforeMessage = null, int max = 0)
        {
            ...
            return await GetItemsAsync<SparkMessage>(path);
        }
        ...
        public async Task<SparkMessage> GetMessageAsync(string messageId)
        {
            var queryParams = new Dictionary<string, string>();
            var path = getURL($"{messagesBase}/{messageId}", queryParams);
            return await GetItemAsync<SparkMessage>(path);
        }
        ...
        /// <returns>Message object.</returns>
        public async Task<SparkMessage> CreateMessageAsync(string roomId = null, string toPersonId = null, string toPersonEmail = null, string text = null, string markdown = null, string[] files = null )
        {
            ...
            return await PostItemAsync<SparkMessage>(messagesBase,postBody);
        }
        ...
        /// <param name="files"></param>
        /// <returns>Message object.</returns>
        public async Task<SparkMessage> CreateFileMessageAsync(string roomId = null, string toPersonId = null, string toPersonEmail = null, string text = null, string markdown = null, MemoryFile file = null)
        {
            var postBody = new Dictionary<string, object>();
            if (roomId != null) postBody.Add("roomId", roomId);
            if (toPersonId != null) postBody.Add("toPersonId", toPersonId);
            ...
            if (text != null) postBody.Add("text", text);
            if (markdown != null) postBody.Add("markdown", markdown);
            if (file != null) postBody.Add("file_bytes", file);
