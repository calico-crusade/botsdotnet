...
namespace BotsDotNet.WebExTeams.Util
{
    ...
    public static class ImageUtility
    {
        ...
        public static  MemoryFile FileFromImage(this Bitmap bitmap)
        {
            var bytes = bitmap.ToByteArray();
            return FileFromImage(bytes);
        }

        public static MemoryFile FileFromImage(this byte[] imageData, string extension = ".png")
        {
